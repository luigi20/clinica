<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Convenios.aspx.cs" Inherits="Convenios" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        Sigla</label>
                                    <div class="controls">
                                        <asp:TextBox class="form-control" MaxLength="14" ID="txtBoxSigla" type="text" runat="server" />
                                ...
                                <div class="control-group col-md-12">
                                    <label>
                                        Telefone</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtBoxTel" class="form-control col-md-10" type="text" runat="server" onKeyUp=" formataTelefone(this,event)" MaxLength = "14"/>
