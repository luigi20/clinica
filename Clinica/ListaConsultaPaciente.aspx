<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListaConsultaPaciente.aspx.cs" Inherits="ListaConsultaPaciente" %>
                                ...
                                <div class="control-group col-md-12">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" 
                                            BorderColor="White" BorderStyle="Solid" Caption="Consultas" CellPadding="4" 
                                            ForeColor="#333333" GridLines="Vertical" Width="789px" DataKeyNames="Id">
                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                            <Columns>
                                                <asp:BoundField DataField="Id" HeaderText="ID">
                                                <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="nomePaciente" HeaderText="Nome do Paciente" >
                                                ...
                                                <asp:BoundField DataField="dataConsulta" DataFormatString="{0:dd/MM/yyyy}" 
                                                ...
                                                <ItemTemplate>
                                                    <asp:Button ID="btnExcluir" runat="server" OnClick="btnExcluir_Click" Text="Excluir" CausesValidation="false" />
                                                </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>
