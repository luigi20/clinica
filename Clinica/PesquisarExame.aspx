<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisarExame.aspx.cs" Inherits="PesquisarExame" %>
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-10">
                                    <label>
                                        Código</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtBoxCodigo" class="form-control" runat="server" />
                                    </div>
                                </div>
                                ...
                                <div class="control-group col-md-12">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                            BorderStyle="Solid" Caption="Exames" CellPadding="4" ForeColor="#333333" GridLines="Vertical"
                                            Width="789px" DataKeyNames="Codigo">
