<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MarcarConsulta.aspx.cs" Inherits="Formulario3" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Consultas</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        Convenio</label>
                                    <div class="controls">
                                        <asp:DropDownList ID="ddlConvenio" runat="server" Width="300px">
                                            <asp:ListItem Selected="True">Selecione</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="control-group col-md-4">
                                    <label>
                                        Medico</label>
                                    <div class="controls">
                                        <asp:DropDownList ID="ddlMedico" runat="server" DataTextField="Medico" Height="22px"
                                            Width="251px">
                                            <asp:ListItem Selected="True">Selecione</asp:ListItem>
                                        </asp:DropDownList>
                                        </select>
                                ...
                                <div class="control-group col-md-12">
                                    ...
                                    <label>
                                        Data</label>
                                    <div class="controls">
                                        <asp:Calendar ID="CalendarioConsulta" runat="server" Caption="Calendario" Width="220px"
                                            ...
                                            <TitleStyle BackColor="#003399" BorderColor="#3366CC" BorderWidth="1px" Font-Bold="True"
                                                Font-Size="10pt" ForeColor="#CCCCFF" Height="40px" />
                                ...
                                <div class="control-group col-md-12">
                                    <label>
                                        Turno</label>
                                    <div class="controls">
                                        <asp:DropDownList ID="ddlTurno" runat="server" Style="margin-left: 16px; margin-top: 8px">
                                ...
                                <div class="control-group col-md-12">
                                    <br />
                                    Situação:
                                    <asp:RadioButtonList ID="rdbSituacao" runat="server" RepeatDirection="Horizontal"
                                        BorderStyle="Solid" AutoPostBack="True" OnSelectedIndexChanged="rdbSituacao_SelectedIndexChanged">
                                        <asp:ListItem>Agendada</asp:ListItem>
                                        <asp:ListItem Value="Realizada" Enabled="false">Realizada</asp:ListItem>
                                        <asp:ListItem Value="Cancelada" Enabled="false">Cancelada</asp:ListItem>
                                        <asp:ListItem>Retorno</asp:ListItem>
                                    </asp:RadioButtonList>
                                    <asp:RequiredFieldValidator ID="rfvSituacao" ControlToValidate="rdbSituacao" runat="server"
                                        ErrorMessage="* Campo Obrigatorio" ForeColor="Red"></asp:RequiredFieldValidator>
                                    <br />
                                    <asp:Label runat="server" ID="lblMedicamento" Visible="false" Text="Medicamentos:">
                                    </asp:Label>
                                    <asp:TextBox ID="txtBoxMedicamentos" runat="server" Visible="false" Height="100px"
                                        Width="250px"></asp:TextBox>
                                    <div class="controls">
                                        <br />
                                        <asp:Button ID="btnConsulta" runat="server" OnClick="MarcarConsul_Click" Text="Marcar Consulta"
                                            CssClass="btn btn-sucess" BackColor="Green" />
