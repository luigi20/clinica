<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisarRequisicaoExame.aspx.cs"
    Inherits="PesquisarRequisicaoExame" %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        Requisição de Exame</h4>
                                </div>
                            </div>
                            <div class="panel-body">
                                <div class="control-group col-md-10">
                                    <label>
                                        Numero do Exame</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtBoxNumExame" class="form-control" runat="server" />
                                    </div>
                                </div>
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="nomeExame" HeaderText="Exame" Visible="false">
                                                    <FooterStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:TemplateField HeaderText="Exame">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblExame" runat="server" Text='<%# Bind("NomeExame.nome") %>' CausesValidation="false" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="Data" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Data do Exame">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
