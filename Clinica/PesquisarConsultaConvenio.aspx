<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisarConsultaConvenio.aspx.cs" Inherits="PesquisarConsultaConvenio" %>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-10">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox class="form-control col-md-6" ID="txtBoxConvenio" type="text" runat="server"
                                            />
                                    </div>
                                </div>
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Convenio">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblConvenioNome" runat="server" Text='<%# Bind("nomeConvenio.nome") %>'
