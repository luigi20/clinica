<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisarConsulta.aspx.cs"
    Inherits="PesquisarConsulta" %>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-10">
                                    <label>
                                        Numero da Consulta</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtBoxNumConsulta" class="form-control" runat="server" />
                                    </div>
                                </div>
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="CRM">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMedicoCrm" runat="server" Text='<%# Bind("MedicoCrm.crm") %>'
                                                            CausesValidation="false" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
