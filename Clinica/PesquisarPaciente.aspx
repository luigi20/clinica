<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisarPaciente.aspx.cs"
    Inherits="PesquisarPaciente" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-12">
                                    ...
                                    <div class="controls">
                                        ...
                                        <br />
                                        &nbsp;&nbsp;&nbsp;
                                        <asp:GridView ID="gdvDados" runat="server" CellPadding="4" ForeColor="#333333" Width="784px"
                                            AutoGenerateColumns="False" Caption="Pacientes" HorizontalAlign="Center" DataKeyNames="Cpf">
