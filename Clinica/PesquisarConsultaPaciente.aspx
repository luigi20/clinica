<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisarConsultaPaciente.aspx.cs"
    Inherits="ListaConsultaPaciente" %>
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="CRM">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMedicoCrm" runat="server" Text='<%# Bind("MedicoCrm.nome") %>'
                                                            CausesValidation="false" />
                                                        <itemstyle horizontalalign="Center" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
