<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisarMedico.aspx.cs"
    Inherits="PesquisarMedico" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        CRM</label>
                                    <div class="controls">
                                        <asp:TextBox class="form-control" MaxLength="14" ID="txtBoxCrm" type="text" runat="server" />
                                    </div>
                                </div>
                                ...
                                <div class="control-group col-md-12">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                            BorderStyle="Solid" Caption="Medicos" CellPadding="4" ForeColor="#333333" GridLines="Vertical"
                                            Width="789px" DataKeyNames="Crm">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="numAtendimento" HeaderText="Num. de Atendimento">
                                                    <FooterStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
