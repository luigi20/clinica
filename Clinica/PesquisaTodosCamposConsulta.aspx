<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PesquisaTodosCamposConsulta.aspx.cs"
    Inherits="PesquisaTodosCamposConsulta" %>
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-10">
                                    <label>
                                        CRM do Medico</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtBoxCRM" class="form-control" type="text" runat="server" />
                                    </div>
                                </div>
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        ID do Convenio</label>
                                    <div class="controls">
                                        <asp:TextBox class="form-control" ID="txtBoxConvenio" type="text" runat="server" />
                                    </div>
                                </div>
                                <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtBoxData" runat="server" onKeyUp=" formataData(this,event);" MaxLength="10"></asp:TextBox>
                                        <br />
                                    </div>
                                </div>
                                ...
                                <div class="control-group col-md-12">
                                    &nbsp;<br />
                                    Situação da Consulta<asp:RadioButtonList ID="rdbSituacao" runat="server"
                                        RepeatDirection="Horizontal" BorderStyle="Solid" AutoPostBack="True">
                                            ...
                                            <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Nome do Paciente">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPaciente" runat="server" Text='<%# Bind("NomePaciente.nome") %>'
                                                    ...
                                                    <asp:BoundField DataField="nomeConvenio" HeaderText="Convenio" Visible="false">
                                                        <FooterStyle HorizontalAlign="Center" />
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:TemplateField HeaderText="Convenio">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblConvenio" runat="server" Text='<%# Bind("NomeConvenio.nome") %>'
                                                                CausesValidation="false" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
