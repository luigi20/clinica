<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FilaAtendimento.aspx.cs"
    Inherits="Senha" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>A</strong>tendimento</a><hr />
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-10">
                                    <label>
                                        Tipo de Senha<asp:RadioButtonList ID="rdbTipo" runat="server" RepeatDirection="Horizontal"
                                            BorderStyle="Solid" Width="186px">
                                ...
                                <div class="control-group col-md-12">
                                    <label>
                                        Senha Chamada:
                                        <asp:TextBox class="form-control" ID="txtBoxSenhaChamada" type="text" runat="server"
                                            Width="244px" ReadOnly="True" />
                                        Tipo de Senha:
                                        <asp:TextBox class="form-control" ID="txtBoxTipoSenha" type="text" runat="server"
                                            Width="244px" ReadOnly="True" />
                                    </label>
                                    &nbsp;<div class="controls">
                                    </div>
                                ...
                                <div class="control-group col-md-12">
                                    ...
                                    <div class="controls">
                                        <asp:Button class="btn btn-success" ID="btnGerarSenha" Text="Gerar Senha" runat="server"
                                            OnClick="btnGerarSenha_Click" />&nbsp;
                                        <asp:Button class="btn btn-primary" ID="btnChamarSenha" runat="server" Text="Chamar Senha"
                                            OnClick="btnChamarSenha_Click" />
                                    </div>
                                </div>
                            </div>
                            <!--/panel content-->
