<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Prova_Manu_Pesq_Espec.aspx.cs"
    Inherits="Convenios" %>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-6">
                                    &nbsp;Descricao<asp:TextBox 
                                        ID="txtBoxDescricao" class="form-control" runat="server" Height="143px" 
                                        Width="627px" /><div class="controls">
                                        <asp:RadioButtonList ID="rdbEscolha" runat="server" 
                                            RepeatDirection="Horizontal">
                                            <asp:ListItem Value ="1">E</asp:ListItem>
                                            <asp:ListItem Value = "2">Ou</asp:ListItem>
                                        </asp:RadioButtonList>
                                        <br />
                                        ...
                                        <asp:GridView ID="gdvDados" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                            BorderStyle="Solid" Caption="Especialidade" CellPadding="4" ForeColor="#333333" GridLines="Vertical"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="nomeEspecialidade" HeaderText="Nome">
                                                    <FooterStyle HorizontalAlign="Center" />
